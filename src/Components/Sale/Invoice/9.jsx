    ...
    <div className="global_container">
      ...
      >
        ...
        >
          ...
          <div
            className={`flex justify-between gap-4 items-start w-full ${
              showHead ? "" : "mt-0"
            }`}
          >
            {/* LEFT: Customer Info */}
          ...
          {/* table */}
          <table className="w-full border-collapse min-h-[500px] text-sm">
            <thead>
              <tr>
            ...
            <tbody className="[&>tr>td]:align-top">
              {groupedProducts?.length > 0 ? (
                ...
                <tr>
                  <td
                    colSpan="4"
                    className="text-center border border-gray-300 dark:border-gray-600 p-1"
                  >
                    No items found
                  </td>
                </tr>
            ...
            <div className="w-[35%] print:w-[35%]">
              ...
              <div>
                <p className="flex justify-between whitespace-nowrap font-semibold">
                  <span>Total:</span>
                  {formatCurrency(details?.SaleSummary?.total)} Tk
                </p>
