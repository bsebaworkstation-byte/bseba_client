...
// import { getToken, getBusinessDetails } from "../../Helper/SessionHelper";
...
//       <div ref={printRef} className="p-5 bg-white shadow-md">
//         {/* Header */}
//         <div className="flex justify-between items-center mb-5">
//           <div className="flex items-center gap-3">
//             {/* business logo  */}
//             <div className="w-12 h-14 text-white  font-bold text-xl  dark:text-gray-50">
//               <img
...
//                 ? new Date(details?.SaleSummary.Date).toLocaleDateString(
//                     "en-GB"
//                   )
//                 : ""}
//             </p>
...
//             <p>Due Date: </p>
//             <p>Amount: {details?.SaleSummary?.grandTotal || 0}</p>
//           </div>
//         </div>
...
//                 <td className="border px-3 py-2 text-right">{p.total}</td>
//               </tr>
//             ))}
//           </tbody>
//           <tfoot>
...
//             Amount in Words:{" "}
//             {numberToWords(details?.SaleSummary?.grandTotal || 0)} Taka Only
//           </p>
//         </div>
...
//           <div>
//             <p>Prepared By</p>
//             <div className="border-b w-32 mt-3"></div>
//           </div>
//           <div>
//             <p>Received By</p>
//             <div className="border-b w-32 mt-3"></div>
      ...
      <div ref={printRef}>
        ...
        <div className="flex justify-between px-1 lg:px-5 py-3 my-4 rounded-lg">
          ...
          <div className="flex flex-col text-[12px] lg:text-[13px] w-1/3 font-[500]">
            ...
            <p>Invoice No: {details?.SaleSummary?.InvoiceNo}</p>
            <p>
              Date:{" "}
              {details?.SaleSummary?.Date
                ? (() => {
            ...
            <p>Name : {details?.Users.name}</p>

            <p>Mobile : {details?.Users.mobile}</p>
