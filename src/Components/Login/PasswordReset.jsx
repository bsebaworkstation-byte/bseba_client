...
import { getMobile, setMobile } from "../../Helper/SessionHelper";
...
const PasswordReset = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!password) {
      return toast.error("Password Must Required");
    }
    ...
    try {
      const res = await axios.post(`${BaseURL}/passwordReset`, payload);
      ...
      <div className="w-full max-w-md p-8 bg-blue-900/40 backdrop-blur-xl rounded-xl shadow-lg text-center border border-teal-500/30 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="mt-6">
            ...
            <div className="mb-4 text-left">
              <label className="block font-semibold mb-2 text-white">OTP</label>
              <input
                value={OTP}
                onChange={(e) => {
